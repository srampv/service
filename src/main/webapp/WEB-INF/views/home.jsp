            ...
            <div id="bd">
                ...
                <div id="yui-main">
                    <div class="yui-b">
                        ...
                        <form action="/services/tools/url" method="POST">
                        ...
                        <div align="center">
                            ...
                            <table border="1">
                                ...
                                <c:forEach var="user" items="${urls}" varStatus="status">
                                    <tr>
                                        <td><input type="checkbox" name="param-+${status.index+1}" value="${user.url}"></td>
